...
namespace Unity.Splines.Examples
{
    ...
    public class LoftRoadBehaviour : MonoBehaviour
    {
        ...
        private int SegmentsPerMeter => Mathf.Min(10, Mathf.Max(1, m_SegmentsPerMeter));
        ...
        private void Loft(Spline spline, int widthDataIndex)
        {
            ...
            {
                spline.Evaluate(t, out var pos, out var dir, out var up);
